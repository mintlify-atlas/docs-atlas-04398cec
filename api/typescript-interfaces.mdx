...
This page documents all TypeScript interfaces, types, and enums exported by react-google-recaptcha-v3.

## Provider Interfaces

### IGoogleReCaptchaProviderProps

Props for the `GoogleReCaptchaProvider` component.
...
Props for the `GoogleReCaptcha` component.
...
Props injected by the `withGoogleReCaptcha` HOC.
...
```typescript
import { GoogleReCaptchaProvider, IGoogleReCaptchaProviderProps } from 'react-google-recaptcha-v3';

const providerProps: IGoogleReCaptchaProviderProps = {
...
```typescript
import { IGoogleReCaptchaProviderProps } from 'react-google-recaptcha-v3';

type ContainerConfig = IGoogleReCaptchaProviderProps['container'];
...
type ScriptProps = IGoogleReCaptchaProviderProps['scriptProps'];
